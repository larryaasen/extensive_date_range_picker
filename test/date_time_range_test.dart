...
void main() {
  ...
  test('test previous year', () {
    final range = DateTimeRangeRelative(
        earliest: "-1y@-y",
        latest: "-1y@y",
        base: DateTime(2017, 9, 7, 17, 30));
    expect(range.earliest, DateTime(2016, 1, 1));
    final l = range.latest;
    expect(range.latest, DateTime(2016, 12, 31, 23, 59, 59, 999, 999));
    expect(range.phrase(), 'Previous year');
  });

  test('test the last 5 years', () {
    final range = DateTimeRangeRelative(
        earliest: "-5y@-d", latest: "now", base: DateTime(2017, 9, 7, 17, 30));
  ...
  test('test 3 months from now', () {
    final range = DateTimeRangeRelative(
        earliest: "3m@m", latest: "4m@m", base: DateTime(2017, 9, 7, 17, 30));
    expect(range.earliest, DateTime(2017, 12, 31, 23, 59, 59, 999, 999));
    expect(range.latest, DateTime(2018, 1, 31, 23, 59, 59, 999, 999));
    expect(range.earliestModifier, '3m@m');
    expect(range.latestModifier, '4m@m');
    expect(range.toString(),
        'DateTimeRangeFixed(earliest=2017-12-31 23:59:59.999999, latest=2018-01-31 23:59:59.999999)');
    expect(range.phrase(), 'Dec 31, 2017 - Jan 31, 2018');
  });

  test('test the last 50 years', () {
    final range = DateTimeRangeRelative(
        earliest: "-50y@-y", latest: "now", base: DateTime(2017, 9, 7, 17, 30));
  ...
  test('test relative phrase', () {
    e(const DateTimeRangeRelative(earliest: "now", latest: "now").phrase(),
        "now");
    e(const DateTimeRangeRelative(earliest: "-1d", latest: "now").phrase(),
        "Last 1 day");
    e(const DateTimeRangeRelative(earliest: "-2d", latest: "now").phrase(),
        "Last 2 days");
    e(const DateTimeRangeRelative(earliest: "-12d", latest: "now").phrase(),
        "Last 12 days");
    e(const DateTimeRangeRelative(earliest: "-99d", latest: "now").phrase(),
        "Last 99 days");
    e(const DateTimeRangeRelative(earliest: "now", latest: "1d").phrase(),
        "Next 1 day");
    e(const DateTimeRangeRelative(earliest: "now", latest: "2d").phrase(),
        "Next 2 days");
    e(const DateTimeRangeRelative(earliest: "now", latest: "12d").phrase(),
        "Next 12 days");
    e(const DateTimeRangeRelative(earliest: "now", latest: "112d").phrase(),
        "Next 112 days");
    ...
    if (!isUTC) {
      ...
      expect(
          DateTimeRangeRelative(
                  earliest: "-44d", latest: "44d", base: DateTime(2021, 4, 18))
              .phrase(),
  ...
  test('test relative phrase errors', () {
    ...
    e(const DateTimeRangeRelative(earliest: "now", latest: "").phrase(),
        isNull);
    e(const DateTimeRangeRelative(earliest: "", latest: "now").phrase(),
        isNull);
  });
  ...
  test('test fixed range same', () {
    final range = DateTimeRangeFixed(
        earliest: DateTime(2017, 9, 7, 17, 30),
        latest: DateTime(2017, 9, 7, 17, 30));
  ...
  test('test fixed range future', () {
    final range = DateTimeRangeFixed(
        earliest: null, latest: DateTime(2017, 9, 7, 17, 30));
  ...
  test('test fixed range past', () {
    final range = DateTimeRangeFixed(
        earliest: DateTime(2017, 9, 7, 17, 30), latest: null);
    expect(range.earliest, DateTime(2017, 9, 7, 17, 30));
  ...
  test('test fixed range toString', () {
    final range = DateTimeRangeFixed(
        earliest: DateTime(2017, 8, 7, 17), latest: DateTime(2017, 9, 7, 17));
    expect(range.toString(),
